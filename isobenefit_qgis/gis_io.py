...
def apply_plan_style(rast_layer):
    """Apply the categorical palette for the recommended-plan raster. New development is coloured per
    density tier (built and mixed-use centres in distinct hues); existing fabric is a muted shade."""
    classes = [
