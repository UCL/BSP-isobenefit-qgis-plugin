...
Preparation also rules out land that could never host viable
development. Growth is contiguous, so a new settlement can never
outgrow the connected patch of buildable land it starts in. A patch
that touches no existing fabric and is smaller than the minimum
settlement size is therefore reclassified as protected green: it stays
walkable and counts as green space, and the simulation never builds on
it.
...
Buildable pockets detached from existing fabric and smaller than the
minimum settlement are reclassified as protected green before the run &
Extension \\
\addlinespace
...
accommodates about 22{,}000 of the 30{,}000 target with 99\% of all homes
served (within the walk of both a centre and green), a mean centre walk
of 219~m, and a mean green walk of 95~m.
...
four outputs, which \path{scripts/demo_run_report.py} regenerates. The raw grown state credits 83\% of the target, and pruning reduces
this to 54--55\%. This window grows part of its population as detached
...
only in centres, optimised placement cuts the mean centre walk from 267
to 200~m with eight more centre areas than as grown (29 against 21),
and fewest centres keeps most of that reduction (217~m) with two fewer.
...
\midrule
Population accommodated & 9{,}918 & 6{,}555 & 6{,}534 & 6{,}534 \\
Share of target & 83\% & 55\% & 54\% & 54\% \\
Built cells (incl.\ existing) & 2{,}045 & 1{,}569 & 1{,}569 & 1{,}569 \\
Mixed-use centre areas & 32 & 21 & 29 & 27 \\
Served coverage (centre and green) & 98\% & 96\% & 98\% & 98\% \\
Mean walk to a centre (m) & 282 & 267 & 200 & 217 \\
Mean walk to green (m) & 109 & 102 & 102 & 102 \\
Centre \sqm{} per person & 6 & 17 & 20 & 21 \\
Green \sqm{} per person & 840 & 1{,}452 & 1{,}457 & 1{,}457 \\
\bottomrule
\end{tabular}
\end{table}
...
At the baseline walk the plan accommodates about 13{,}200 residents,
meeting the 13{,}000
target with 87\% of homes served, a mean centre walk of 223~m, and a mean
green walk of 112~m (Figure~\ref{fig:crewshill}). Shifting the shares
one step toward the high tier houses 4\% more people on 5\% fewer built
...
At the baseline walk the plan accommodates about 36{,}700 of the 40{,}000
target with 70\% of homes served and a mean centre walk of 136~m
...
raises the accommodated population to about 42{,}100 and lowers
coverage to 60\%, because the denser contiguous fabric pushes more
...
mean walk in every case, while served coverage moves by a few
percentage points at most, because the plan options keep new homes
within the permitted walk at every setting. Cambourne holds 95--99\%
coverage across the sweep, and Pajarito moves least because the terrain
mask binds the form before the centre walk does. Windows dominated by
existing fabric sit lower on the coverage metric, which counts every
...
\midrule
Cambourne & 95\% & 155~m & 99\% & 219~m & 99\% & 243~m \\
Crews Hill & 86\% & 121~m & 87\% & 223~m & 89\% & 324~m \\
Pajarito & 70\% & 100~m & 70\% & 136~m & 71\% & 179~m \\
\bottomrule
\end{tabular}
\end{table}
...
Under the pre-plan reading, the model regrows 1{,}536 cells housing about
13{,}800 residents, and 69\% of that growth falls inside the district
boundaries, with Rieselfeld taking 1{,}044 cells. The concentration
...
planners set aside for the reserve (0.22) than on the land they built
(0.16). The regrown plan's mean walks are shorter than the real
districts' (305~m against 397~m to a centre), which follows from the
...
intersection over union of 0.11 at 200~m to 0.06 at 600~m. The real
...
\midrule
New cells & 1{,}800 & 1{,}536 & 1{,}264 \\
Population & 16{,}200 & 13{,}824 & 11{,}376 \\
Growth inside the district boundaries & 67\% & 69\% & 69\% \\
Footprint overlap (intersection over union) & 0.11 & 0.10 & 0.06 \\
Mean walk to a centre (m) & 308 & 305 & 308 \\
Mean walk to green (m) & 190 & 190 & 182 \\
...
mean build likelihood on their real footprint is 0.005, and only 2\% of
...
4{,}400 residents against the existing fabric elsewhere in the window.
...
\midrule
Built cells (district / new) & 1{,}929 & 1{,}536 & 489 \\
Population & 16{,}000 & 13{,}824 & 4{,}401 \\
Mean walk to a centre (m) & 397 & 305 & 316 \\
Mean walk to green (m) & 171 & 190 & 196 \\
Growth inside the district boundaries & --- & 69\% & 2\% \\
Footprint overlap (intersection over union) & --- & 0.10 & 0.002 \\
Mean build likelihood on the real footprint & --- & 0.16 & 0.005 \\
\bottomrule
\end{tabular}
\end{table}
...
concentrates inside the district boundaries (67\% at 200~m, 69\% at
...
The gap between the raw grown state and the plan options (83\% against 54\%
...
threshold that removes a third
...
settings, such as footprint overlaps of 0.11 against 0.10 or mean walks a
