...
| New centralities seed near built land that has outgrown its centres, with probability 0.005 | Same trigger; the probability is fixed at 0.01 and at most one new centre seeds per iteration; a centre that ends up below the viability threshold is removed in post-processing | Modified: added guards |
