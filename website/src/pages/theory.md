...
| All nature is available to build | Buildable pockets too small to hold the minimum settlement are set aside as protected green before the run; a pocket enclosed by a town becomes a pocket park | Extension |
