...
| The grid starts as uniform nature | Real inputs from OpenStreetMap: existing built fabric (frozen), protected green, unbuildable land including corridors carved from motorways, railways and rivers, centre areas, stops and stations | Extension |
